...
const sodaApi = "https://api.openweathermap.org/data/2.5/forecast?id=5607916&appid=11eda4f6c23c30829f26d495b3e62fe3&units=imperial";
  ...
  .then((sodaweather) => {
     ...
     for (let i = 0; i < mylist.length; i++) {
        ...
        if (time.includes('18:00:00')) {
            ...
            let weathericon = sodaweather.list[i].weather[0].icon;
            ...
            fivetemp.textContent = sodaweather.list[i].main.temp + '\xB0';
